...
|---|---|
| Raspberry Pi 4B | control + recording (hostname `PiLiDAR`) |
...
UART configuration (done automatically by `pilidar` at startup):
...
360°). Implementation: `pilidar/lidar/protocol.py`.
