...
```
pilidar/            Python package (CLI: "pilidar")
...
Concepts (scan-folder-per-scan, mock mode) were inspired by
[PiLiDAR](https://github.com/PiLiDAR/PiLiDAR) and
[PiLiDAR 2.0](https://github.com/ORPA1988/PiLiDAR) — no code was taken
from either (they are CC BY-NC-SA licensed).
